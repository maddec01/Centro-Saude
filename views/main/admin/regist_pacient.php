...
function validateForm() {
	...
	var cartaoUtente=document.registration.cartaoUtente.value;
	...
	else if(!isNumber(cartaoUtente)) {
		alert("Cartão de Utente só pode conter números!")
		return false;
	}
	else if(cartaoUtente==null || cartaoUtente.trim()=="") {
		alert("Cartão de Utente obrigatório!")
		return false;
	}
...
<form method="POST" name='registration' action="index.php?view=user_registOK&type=staff" onsubmit="return validateForm();">
<div align="center">
...
<font face="Arial">
	...
	<tr>
		...
		<td width="50%"><input name="nome" type="text" maxlength="100"></td>
	</tr>
	<!-- --------- 3ª Linha --------------- -->
	<tr>
	...
	<tr>
		...
		<td><input name="dataNascimento" type="date"></td>
	</tr>
	<!-- --------- 5ª Linha --------------- -->
	<tr>
		<td align="right">BI/CC:&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input name="bi" type="text" maxlength="10"></td>
	</tr>
	<!-- --------- 5ª Linha --------------- -->
	<tr>
		<td align="right">NIF:&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input name="nif" type="text" maxlength="10"></td>
	</tr>
	<!-- --------- 5ª Linha --------------- -->
	<tr>
		<td align="right">Cartão Utente:&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input name="cartaoUtente" type="text" maxlength="10"></td>
	</tr>
	<!-- --------- 6ª Linha --------------- -->
	<tr>
		<td align="right">Morada:&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input name="morada" type="text" maxlength="100"></td>
	</tr>
	<!-- --------- 6-1ª Linha --------------- -->
	<tr>
		<td align="right">Código Postal:&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input name="codPostal" type="text" maxlength="7"></td>
	</tr>
	<!-- --------- 7ª Linha --------------- -->
	<tr>
		<td align="right">Telefone:&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input name="telefone" type="text" maxlength="9"></td>
	</tr>
	<!-- --------- 8ª Linha --------------- -->
	<tr>
		<td align="right">Telemóvel:&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input name="telemovel" type="text" maxlength="9"></td>
	</tr>
	<!-- --------- 9ª Linha --------------- -->
	<tr>
	...
	<tr>
		...
		<td><input name="pass" type="password" maxlength="20"></td>
	</tr>
	<!-- --------- 13ª Linha --------------- -->
	<tr>
		<td align="right">Confirme a Password:&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input name="pass_confirm" type="password" maxlength="20"></td>
	</tr>
	<!-- ---------   Space  --------------- -->
	<tr>
		<td colspan="2">&nbsp;</td>
