<?php
	...
	$query = 'SELECT * FROM pacientes WHERE (idPaciente = "'.$_GET["id"].'")';
...
<form method="POST" name='registration' action="index.php?view=user_editOK&type=pacient&id=<?php echo $_GET["id"] ?>" onsubmit="return validateForm();">
<div align="center">
...
<font face="Arial">
	...
	<tr>
		...
		<td width="50%"><input name="nome" type="text" maxlength="100" value="<?php echo $registo["nome"]; ?>"></td>
	</tr>
	<!-- --------- 3ª Linha --------------- -->
	<tr>
	...
	<tr>
		...
		<td><input name="cartaoUtente" type="text" maxlength="10" value="<?php echo $registo["cartaoUtente"]; ?>"></td>
	</tr>
	<!-- --------- 6ª Linha --------------- -->
	<tr>
